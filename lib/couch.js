...
Couch.prototype._loadViews = function() {
  return this._runCommand(__dirname + '/../node_modules/.bin/npm run load --npm-registry-couchapp:couch=' + this.registryUrl() + '/' + this.testRegistryName);
};

Couch.prototype._copyViews = function() {
  return this._runCommand(__dirname + '/../node_modules/.bin/npm run copy --npm-registry-couchapp:couch=' + this.registryUrl() + '/' + this.testRegistryName);
};
...
Couch.prototype._runCommand = function(command) {
  ...
  return new Promise(function(resolve, reject) {
    exec(
      command,
      {
        cwd: __dirname + '/../node_modules/npm-registry-couchapp',
